...
export function BottomNav() {
  ...
  return (
    <div className=" fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-[450px]">
      <div className="bg-black/80 backdrop-blur-2xl border border-white/10 rounded-[2rem] p-2 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex items-center justify-between px-8 h-20">
